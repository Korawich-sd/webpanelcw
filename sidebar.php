    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.php"><img src="image/logodoj.png" alt="Logo"  style="width: 100px; height: 100px;"></a>
                </div>
                <span style="font-size: 18px;">DOJ SYSTEM</span>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  ">
                    <a href="new_blog" class='sidebar-link'>
